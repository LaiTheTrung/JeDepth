...
class TrainModel(pl.LightningModule):
    ...
    def train_dataloader(self):
        ...
        return torch.utils.data.DataLoader(
            dataset,
            batch_size=self.hparams.batch_size // max(1, self.trainer.num_devices),
    ...
    def val_dataloader(self):
        ...
        return torch.utils.data.DataLoader(
            dataset,
            batch_size=self.hparams.batch_size_val // max(1, self.trainer.num_devices),
...
if __name__ == "__main__":
    ...
    parser = build_parser()
    # Add PL Trainer args manually for PL 2.x
    ...
    if args.pretrain is not None:
        ckpt = torch.load(args.pretrain, weights_only=False)
